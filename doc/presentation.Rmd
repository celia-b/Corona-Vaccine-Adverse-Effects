...
```{r symptom_types_v_manu, echo = FALSE, out.width = "800px", out.height= "500px"}
...
```{r death_v_symptoms_model, echo = FALSE, out.width = "450px", out.height= "350px"}
include_graphics("../results/death_v_symptoms_model_fig.png")
```

16 out of 19 symptoms are significant in the model - confounding factors?
