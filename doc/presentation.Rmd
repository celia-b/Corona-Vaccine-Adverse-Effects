...
```{r death_v_profile_model, eval=TRUE, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE}
...
```{r death_v_profile_pval, echo = FALSE, out.width = "600px", out.height= "400px"}
include_graphics("../results/death_v_profile_model_fig_pval.png")
```

## 04_analysis_modeling - Logistic regression: death ~ patient profile

```{r death_v_profile_odds, echo = FALSE, out.width = "600px", out.height= "400px"}
include_graphics("../results/death_v_profile_model_fig_odds.png")
```
...
```{r death_v_symptoms_model, eval=TRUE, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE}
...
```{r death_v_symptoms_pval, echo = FALSE, out.width = "600px", out.height= "400px"}
include_graphics("../results/death_v_symptoms_model_fig_pval.png")
```

## 04_analysis_modeling - Logistic regression: death ~ symptoms

```{r death_v_symptoms_odds, echo = FALSE, out.width = "600px", out.height= "400px"}
include_graphics("../results/death_v_symptoms_model_fig_odds.png")
```
...
```{r symptoms_v_antiinfl_manhattan, echo = FALSE, out.width = "600px", out.height= "400px"}
include_graphics("../results/symptoms_v_antiinflamatory_model_fig_manhattan.png")
```

## 04_analysis_modeling - Many logistic regressions: symptoms ~ takes anti-inflamatory

```{r symptoms_v_antiinfl_odds, echo = FALSE, out.width = "600px", out.height= "400px"}
include_graphics("../results/symptoms_v_antiinflamatory_model_fig_odds.png")
```
