...
Another example is OTHER_MEDS. Because it is not recommended to take antiinflammatory or steroid drugs before receiving a vaccine, we detect which individual have taken them to later make some analyses.
...
```{r age_dist, echo = FALSE, out.width = "500px", out.height= "400px"}
include_graphics("../results/age_dist.png")
```

## 04_analysis_visualizations - Sex distribution

```{r sex_dist, echo = FALSE, out.width = "500px", out.height= "400px"}
include_graphics("../results/sex_dist.png")
```

## 04_analysis_visualizations - Vaccine manufacturer distribution

```{r vac_dist, echo = FALSE, out.width = "500px", out.height= "400px"}
include_graphics("../results/vac_dist.png")
```

## 04_analysis_visualizations - Age/sex vs. number of symptoms

```{r nsymptoms_age_sex, echo = FALSE, out.width = "700px", out.height= "450px"}
...
```{r nsymptoms_v_manu, echo = FALSE, out.width = "500px", out.height= "400px"}
...
```{r symptom_types_v_age, echo = FALSE, out.width = "550px", out.height= "500px"}
include_graphics("../results/symptom_types_v_age.png")
```


## 04_analysis_visualizations - Sex vs. symptom types 

```{r symptom_types_v_sex, echo = FALSE, out.width = "650px", out.height= "500px"}
...
```{r symptom_types_v_manu, echo = FALSE, out.width = "650px", out.height= "500px"}
...
```{r manu_v_death, echo = FALSE, out.width = "500px", out.height= "400px"}
...
```{r death_v_symptoms_model, echo = FALSE, out.width = "500px", out.height= "450px"}
include_graphics("../results/death_v_symptoms_model_fig.png")
```
